...
rm_var <- c("varname", "outcomeID", "prob_mean", "wave_base1", "behcli", "g", "INC", "PRPOS", "GR1", "GR2", "GR3", "type", 
            "w1", "w2", "w3", "w4", "w5", "w6", "w7", "w8", "flag_change", "m", "c", "multiple", "d", "dv", "wt", "grpname", "inflbhvr",
...
df <- read_csv(paste0(mac, "Zone/7_MBI_Database/MBX Stuff to Share/dat2_rev1.csv"))      # 1st revision
...
# "SUBS",                               # subsample             !!! open
"GR1.y",                              # the study can be included in group 1 (lifestyle)
"GR2.y",                              # the study can be included in group 2 (HIV)
"GR3.y"                              # the study can be included in group 3 (alcohol/drug)
...
ps_var2 <- names(df2)[qualify_var2]                                               # recptmsi -> RCPTFsi

# show missing proportions
sapply(df2, function(i){sum(is.na(i))/length(i)})["pubyear"]
sort(ps_var2)
```
